...
public class Exercise11 {
    ...
    private void computePermutations(PermutationNumber[] array) {
        ...
        Insertion.sort(insertionSortCopy);
        ...
        Selection.sort(selectionSortCopy);
